...
import com.katkat_maker.Blog.Security.BlogUserSecurity;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
       try {
            ...
            if (token != null) {
                ...
                if (userDetails instanceof BlogUserSecurity) {
                    request.setAttribute("userId", ((BlogUserSecurity) userDetails).getId());
                }
            }
        } catch (Exception e){
